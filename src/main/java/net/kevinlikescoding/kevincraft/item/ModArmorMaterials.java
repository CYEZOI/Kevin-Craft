...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    IRON_GOLD("iron_gold", 20, new int[]{2, 5, 6, 2}, 30, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.of(ModItems.IRON_GOLD_INGOT.get()));
    ...
    public String getName() {
        return KevinCraft.MOD_ID + ":" + this.name;
    }
